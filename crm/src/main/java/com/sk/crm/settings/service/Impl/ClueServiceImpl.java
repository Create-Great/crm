...
import com.sk.crm.settings.dao.*;
import com.sk.crm.settings.domain.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convertT(String clueId, Tran t, String createBy) {
        ...
        /*
            经过第二步处理后,客户的信息我们已经拥有了,将来在处理其他表的时候,如果要用到用户的id
            直接使用cus.getId()
         */
        ...
        if (count2 != 1) {
         ...
         /*
            经过第二步处理后,客户的信息我们已经拥有了,将来在处理其他表的时候,如果要用到联系人的id
            直接使用con.getId()
         */
        ...
        if (t != null) {
            ...
            //可以通过第一步生成的c对象,取出一些信息,完善对t对象的封装
