	...
	<script type="text/javascript">
		$(function () {
			...
			/*
				...
				根据为"用户创建交易"的复选框是否挑√，来判断是否需要创建交易
			 */
			$("#convertBtn").click(function () {

				if ($("#isCreateTransaction").prop("checked")){
					// 需要创建交易
					//window.location.href="workbench/clue/convert.do?clueId=${param.id}&money=xx&";
					// 使用form表单提交
					$("#tranForm").submit();

				} else {
					// 不需要
					window.location.href="workbench/clue/convertT.do?clueId=${param.id}";
				}
			})
		});
	</script>
...
<div id="create-transaction2"
	...
	<!--提交表单-->
	<form id="tranForm" action="workbench/clue/convertT.do" method="post">
